...
使用示例:
```python
from h5hf_omni_dataset import OmniDataset, get_dataloader

# 自动检测格式创建数据集
dataset = OmniDataset(
    path="/home/data/OmniShape1k_18000a_128x128_20251204.h5",
...
def OmniDataset(
    ...
    if format == "h5":
        ...
        # HF 默认 split 为 "train"
        hf_split = split if split is not None else "train"
